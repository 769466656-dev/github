...
def load_stock_data(stock_code, start_date=None, end_date=None):
    ...
    参数:
        stock_code: 股票代码，如 '600522.SH'
        start_date: 开始日期，如 '2026-01-01'
        end_date:   结束日期，如 '2026-08-10'
...
def plot_backtest(result, stock_code='', title=''):
    ...
    import matplotlib
    # macOS 使用 PingFang SC；保留其他常见中文字体作为兼容回退
    matplotlib.rcParams['font.sans-serif'] = ['PingFang SC', 'Arial Unicode MS', 'Heiti TC']
