...
-- Tushare 股票主数据、估值/流动性、复权因子与交易日历
CREATE TABLE IF NOT EXISTS trade_stock_master (
    stock_code VARCHAR(20) PRIMARY KEY,
    stock_name VARCHAR(100), industry VARCHAR(100), list_date DATE, exchange VARCHAR(10),
...
CREATE TABLE IF NOT EXISTS trade_stock_daily_basic (
    ...
    turnover_rate DECIMAL(12,6), float_mv DECIMAL(24,4) COMMENT '万元', total_mv DECIMAL(24,4) COMMENT '万元',
    ...
    PRIMARY KEY(stock_code, trade_date), KEY idx_daily_basic_date(trade_date)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='每日估值与流动性指标';
...
CREATE TABLE IF NOT EXISTS trade_market_calendar (
    exchange VARCHAR(10) NOT NULL, cal_date DATE NOT NULL, is_open TINYINT NOT NULL, pretrade_date DATE,
    data_source VARCHAR(20) NOT NULL, created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS trade_report_consensus (
    ...
    net_profit_forecast DECIMAL(20,2) COMMENT '预测净利润（接口原始单位）',
